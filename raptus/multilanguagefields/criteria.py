...
criteria.registerCriterion(criteria.ATSortCriterion, SORT_INDICES)
criteria.registerCriterion(criteria.ATSimpleStringCriterion, STRING_INDICES)
criteria.registerCriterion(criteria.ATSimpleIntCriterion, LIST_INDICES)
criteria.registerCriterion(criteria.ATSelectionCriterion, LIST_INDICES)
criteria.registerCriterion(criteria.ATListCriterion, LIST_INDICES)
criteria.registerCriterion(criteria.ATReferenceCriterion, REFERENCE_INDICES)
criteria.registerCriterion(criteria.ATDateRangeCriterion, RELEVANT_INDICES)
criteria.registerCriterion(criteria.ATDateCriteria, DATE_INDICES)
criteria.registerCriterion(criteria.ATBooleanCriterion, FIELD_INDICES)